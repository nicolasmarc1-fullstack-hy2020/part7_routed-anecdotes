  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input required {...content.field} />
        </div>
        <div>
          author
          <input required {...author.field} />
        </div>
        <div>
          url for more info
          <input
      ...
      <Switch>
        ...
        <Route path="/anecdotes/:id">
          {anecdote ? (
            ...
            <h2>Annecode not found</h2>
          )}
        </Route>
        {/* can use exact path or more specfic to generic order */}
